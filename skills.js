...
// Petit halo qui suit la souris sur les fonds a pointilles (cartes de
// competences, plan d'action, bandeau disponibilite), pour donner un
// leger retour visuel au survol sans surcharger le design.
const reduceMotionQuery = window.matchMedia('(prefers-reduced-motion: reduce)');
if (!reduceMotionQuery.matches) {
  document.querySelectorAll('.skill-card, .availability-strip').forEach((el) => {
